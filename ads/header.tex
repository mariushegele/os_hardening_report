...
\newcommand{\checkb}{\rlap{$\square$}{\raisebox{2pt}{\large\hspace{1pt}\cmark}}\hspace{-2.5pt}}
\newcommand{\nocheckb}{$\square$}
...
\lstloadlanguages{Python,bash,[gnu]make}
\lstdefinelanguage{basha}{
  	language=bash,
  	morekeywords={sips, \$},
}
